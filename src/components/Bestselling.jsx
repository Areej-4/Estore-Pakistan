...
<img className="block relative rounded overflow-hidden cursor-pointer rounded-lg  mt-20" src={x.thumbnail} alt="content" />
                ...
                >
                  <Link to={`/bestselling/${x.id}`}>
                    <div className="px-20 py-16 container text-center transform rounded-xl transition duration-300 hover:scale-105">
                      <img
                        alt="ecommerce"
                        className="block relative rounded overflow-hidden cursor-pointer rounded-lg mt-20"
                        src={x.thumbnail}
                      />
                      <div>
